  ...
  <body>
    <section class="section">
      <div class="container">
        ...
        <nav class="panel">
          <p class="panel-heading">Métodos</p>
          <a class="panel-block" href="CreateCertificate_CNPJ.php?type=cnpj&code=C01RPJA1SO12">CreateCertificate_CNPJ &nbsp;&nbsp; <span class="tag is-info">e-CNPJ A1 12M</span></a>
